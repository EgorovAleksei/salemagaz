...
class Products(models.Model):
    ...
    brand = models.ForeignKey(to=Brand, db_column='brand', on_delete=models.SET_NULL, verbose_name='Брэнд', null=True, blank=True)
    category = TreeForeignKey(to=Category, db_column='category', on_delete=models.CASCADE, verbose_name='категория', null=True)
